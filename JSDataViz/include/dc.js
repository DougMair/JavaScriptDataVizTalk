    ...
    dc.heatMap = function (parent, chartGroup) {
      ...
      _chart._doRedraw = function () {
        ...
        dc.transition(boxes.selectAll('rect'), _chart.transitionDuration())
            ...
            .attr('fill', _chart.getColor)
            .attr('width', boxWidth - 1)    // [dmm] sub 1 to get separation
            .attr('height', boxHeight - 1); // [dmm] sub 1 to get separation

        // Added by [dmm] to show labels in cells
        if (_chart.label()) {
          gEnter.append('text')
            .text(function (d, i) { return _chart.label()(d) })
            .attr('x', function (d, i) { return cols(_chart.keyAccessor()(d, i)) + boxWidth / 2; })
            .attr('y', function (d, i) { return rows(_chart.valueAccessor()(d, i)) + boxHeight / 2; })
            .attr('dy', 6)
            .attr("font-family", "open sans")
            .attr("font-size", Math.round(boxHeight / 2) + "px")
        ...
        gColsText.enter().append('text')              
              .style('text-anchor', 'middle')
              .attr('y', -24) //_chart.effectiveHeight()) [dmm] move to top of chart
              .attr('dy', 12)
              .attr("font-family", "open sans")
              .attr("font-size", Math.round(boxHeight / 2) + "px")
